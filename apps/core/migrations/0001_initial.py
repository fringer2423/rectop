    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('last_date_load_reviews', models.DateTimeField(default=datetime.datetime(2022, 11, 3, 1, 35, 40, 60164), verbose_name='Последняя дата загрузки отзывов')),
                ('is_detected', models.BooleanField(default=False, verbose_name='Филиал обработан системой')),
            ],
            options={
                'verbose_name': 'Филиал',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('branch', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.branch', verbose_name='Филиал')),
                ('connect', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='reviews', to='core.connect')),
            ],
            options={
                'verbose_name': 'Отзыв',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.IntegerField(choices=[(0, 'Тестовый'), (1, 'Начальный'), (2, 'Средний'), (3, 'Профессиональный')], default=0)),
                ('user', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='rate', to=settings.AUTH_USER_MODEL, verbose_name='Пользователь')),
            ],
            options={
                'verbose_name': 'Тариф',
