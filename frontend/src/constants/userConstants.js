...
export const USER_VERIFY_LOGIN_REQUEST = "USER_VERIFY_LOGIN_REQUEST";
export const USER_VERIFY_LOGIN_SUCCESS = "USER_VERIFY_LOGIN_SUCCESS";
export const USER_VERIFY_LOGIN_FAIL = "USER_VERIFY_LOGIN_FAIL";
