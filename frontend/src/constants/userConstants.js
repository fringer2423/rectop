...
export const USER_VERIFY_LOGIN_REQUEST = 'USER_LOGIN_CHECK_REQUEST'
export const USER_VERIFY_LOGIN_SUCCESS = 'USER_LOGIN_CHECK_SUCCESS'
export const USER_VERIFY_LOGIN_FAIL = 'USER_LOGIN_CHECK_FAIL'
