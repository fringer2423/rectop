            ...
            <Container>
                <div id="first-block">
                    <div className="first-block-text">
                        ...
                        <h1>
                            <b>
                                {" "}
                                <span className="gradient-text">RecTop</span> -
                                инновационный сервис
                            </b>{" "}
                            <span className="cursive-text special">
                        ...
                        <div className="small-text">
                            ...
                            <ul>
                                <li>
                                    ...
                                    позволит разрешить конфликтную ситуацию
                                    вовремя и без последствий. Получайте
                                    уведомления о новых отзывах в Telegram,
                                    отвечайте из личного кабинета
                                </li>
                            </ul>
                        </div>
                    </div>
                ...
                <div className="get-reports">
                    <h1>
                        <b>
                            Получайте{" "}
                            <span className="gradient-text">положительные</span>{" "}
                            отзывы
                        </b>
                    </h1>
                    <div className="get-reports-text">
                        Наша команда ежедневно просматривает и анализирует
                        крупнейшие популярные сервисы по сбору отзывов
                    </div>
                    <div className="get-reports-equality">
                        Больше положительных отзывов = Больше доверия = Больше
                        продаж
                    </div>
                    ...
                    <div className="wrapper-for-purple-block">
                        <div className="purple-block">
                            ...
                            <div className="text-in-pb">
                                <h2>
                                    <b>
                                        Сбор отзывов по QR-коду при посещении
                                        вашего заведения онлайн/оффлайн
                                    </b>
                                </h2>
                                <p>
                                    Уникальная система мотивации оставления
                                    отзывов от клиентов. Клиент получает кэшбек
                                    за отзыв на любом сервисе - его можно
                                    обменять на скидку/услугу у партнеров.
                                </p>
                            </div>
                            <img
                ...
                <div id="work">
                    ...
                    <div className="small-text">
                        Уникальный генератор отзывов о компании. Эффективно и
                        просто: клиент сканирует QR-код, оставляет отзыв, вы
                    ...
                    <div className="block-with-pic-two">
                        ...
                        <div className="block-with-pic-two-text">
                            ...
                            <div>
                                <ul>
                                    <li>
                                        Устраняйте конфликтные ситуации в чате
                                        службы поддержки в Telegram.
                                    </li>
                                    <li>
                                        Вовремя разрешённый конфликт –
                                        отсутствие негативных отзывов в сети.
                                    </li>
                                </ul>
                            </div>
                            <button className="blue-button">
                ...
                <div className="recommendations">
                    ...
                    <h2>
                        Один негативный отзыв - это 100 положительных, и если вы
                ...
                <div id="tariffs">
                    ...
                    <span className="header-tariffs">
                        <h1>
                            <b>
                                Выбирайте то, что удобно Вам для управления
                                репутацией
                            </b>
                        </h1>
                    </span>
                    {loading ? (
                        ...
                        <h4 className="text-danger mt-3 text-center">
                            Произошла ошибка. Попробуйте загрузить информацию о
                            тарифах позже
                        </h4>
                    ) : (
                ...
                <div id="contacts">
                    <div className="text-contacts">
                        ...
                        <p>
                            Наш менеджер перезвонит вам через 10 минут, в
                            течение которых вы сможете:
                        </p>
                        <ul>
                            <li>
                                <span>
                                    Узнать все отзывы о своей компании и как их
                                    отработать.
                                </span>
                            </li>
                            <li>
                                <span>
                                    Получить список интернет-ресурсов, на
                                    которых нужно зарегистрировать компанию.
                                </span>
                            </li>
                            <li>
                                <span>
                                    Проанализировать общий рейтинг компании и
                                    каждой точки продаж в отдельности.
                                </span>
                            </li>
                            <li>
                                <span>
                                    Узнать откуда берутся негативные отзывы и
                                    как удалить негативный отзыв без бюджета.
                                </span>
                            </li>
                        </ul>
                        <span className="text-contacts-computer">
                            <p>
                                <b>RecTop - Ваша репутация!</b>
                            </p>
                        </span>
                    </div>
                    <div className="text-contacts-mobile">
                        <b>
                            Подарим доступ к сервису “Электронная книга отзывов
