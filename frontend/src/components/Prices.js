...
const Prices = ({ rateInfo }) => {
    ...
    const [priceDurationFirst, setPriceDurationFirst] = useState(
        priceWeek.first + "РУБ./НЕД."
    );
    const [priceDurationSecond, setPriceDurationSecond] = useState(
        priceWeek.second + "РУБ./НЕД."
    );
    const [priceDurationThird, setPriceDurationThird] = useState(
        priceWeek.third + "РУБ./НЕД."
    );
    ...
    const toSetThirdPrice = () => {
        if (activeIndex === 0) {
            setPriceDurationThird(
                countPrices(numBranchsThird, priceWeek.third, sales)
                    .resultPrice + " РУБ./НЕД."
            );
            setPriceOldThird(
        ...
        if (activeIndex === 2) {
            setPriceDurationThird(
                countPrices(numBranchsThird, priceYear.third, sales)
                    .resultPrice + " РУБ./ГОД."
            );
            setPriceOldThird(
    ...
    const toSetFirstPrice = () => {
        if (activeIndex === 0) {
            setPriceDurationFirst(
                countPrices(numBranchsFirst, priceWeek.first, sales)
                    .resultPrice + " РУБ./НЕД."
            );
            setPriceOldFirst(
        ...
        if (activeIndex === 2) {
            setPriceDurationFirst(
                countPrices(numBranchsFirst, priceYear.first, sales)
                    .resultPrice + " РУБ./ГОД."
            );
            setPriceOldFirst(
    ...
    const handleClickSecondPrice = () => {
        ...
        setPriceOldSecond(
            countPrices(numBranchsSecond, second, sales).oldPrice + " РУБ./МЕС."
        );
        setPriceOldThird(
            countPrices(numBranchsThird, third, sales).oldPrice + " РУБ./МЕС."
        );
    };
        ...
        <>
            ...
            <div id="list-of-prices">
                <div className="table-for-price-first">
                    <h3>
                        <b>“Генератор отзывов”</b>
                    </h3>
                    <h5>{numBranchsFirst} филиал</h5>
                    <div className="wrapper-spinner">
                        <button
                            className="control-button-spinner"
                            onClick={handleFirstLeftClick}
                        >
                            -
                        </button>
                        <Form.Range
                            className="range-for-prices"
                            ref={refFirst}
                    ...
                    <div className="block-in-table">
                        <b>Производите сбор отзывов </b> от ваших клиентов при
                        помощи QR-кодов на точках продаж
                    </div>
                ...
                <div className="table-for-price-second">
                    <h3>
                        <b>Какое-то название</b>
                    </h3>
                    <h5>{numBranchsSecond} филиал</h5>
                    <div className="wrapper-spinner">
                        <button
                            className="control-button-spinner"
                            onClick={handleSecondLeftClick}
                        >
                            -
                        </button>
                        <Form.Range
                        ...
                        <button
                            className="control-button-spinner"
                            onClick={handleSecondRightClick}
                        >
                            +
                        </button>
                    </div>
                    ...
                    <div className="block-in-table">
                        <b>Работа с отзывами</b> на крупнейших
                        интернет-площадках и сервисах
                    </div>
                    <div className="text-in-price">
                ...
                <div className="table-for-price-third">
                    <h3>
                        <b>Репутация под ключ</b>
                    </h3>
                    <h5>{numBranchsThird} филиал</h5>
                    <div className="wrapper-spinner">
                        <button
                            className="control-button-spinner"
                            onClick={handleThirdLeftClick}
                        >
                            -
                        </button>
                        <Form.Range
                ...
                <Carousel className="carousel-for-prices" interval={null}>
                    <Carousel.Item>
                        <div className="table-for-price-first">
                            ...
                            <div className="block-in-table">
                                <b>Производите сбор отзывов </b> от ваших
                                клиентов при помощи QR-кодов на точках продаж
                            </div>
                            <div className="text-in-price">
                                Сбор отзывов
                                <hr />
