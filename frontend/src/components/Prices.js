...
const Prices = () => {
        ...
        const priceWeek = {
            ...
            second: countWeekDefaultPrice(priceMonth.second, weekRatio),
            third: countWeekDefaultPrice(priceMonth.third, weekRatio)
        }

        const priceYear = {
            first: countYearDefaultPrice(priceMonth.first, yearRatio),
            second: countYearDefaultPrice(priceMonth.second, yearRatio),
            third: countYearDefaultPrice(priceMonth.third, yearRatio)
        }
